                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    Button {
                        withAnimation(.spring(response: 0.3, dampingFraction: 0.8)) {
                            if isIphone {
                                appState.coordinator.dismiss(style: .fullScreen)
                            } else {
                    ...
                    VStack(spacing: 24) {
                        ...
                        .background(
                            RoundedRectangle(cornerRadius: 16)
                                .fill(appState.currentTabThemeColors.secondaryColor.opacity(0.5))
                                //.shadow(color: appState.currentThemeColors.secondaryColor.opacity(0.05), radius: 10)
                        )
                        .padding(.horizontal)
                            ...
                            VStack(alignment: .leading, spacing: 8) {
                                ...
                                .background(
                                    RoundedRectangle(cornerRadius: 12)
                                        ...
                                        .overlay(
                                            RoundedRectangle(cornerRadius: 12)
                                                .stroke(isPasswordFocused ? appState.currentTabThemeColors.primaryColor : Color.clear, lineWidth: 1)
                                        )
                                )
                            }
                            .opacity(showContent ? 1 : 0)
