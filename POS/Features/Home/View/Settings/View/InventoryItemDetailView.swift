...
//struct IngredientUsageDetailView: View {
...
//                        Text("Số lượng:")
//                        Spacer()
//                        Text("\(item.quantity) \(item.measurement.unit)")
//                            .foregroundColor(.secondary)
//                    }
//                    
//                    HStack {
...
//                        Spacer()
//                        Text("\(item.minQuantity) \(item.measurement.unit)")
//                            .foregroundColor(.secondary)
//                    }
//                }
//                
...
//                    Task {
//                        await viewModel.deleteIngredientUsage(item)
//                        dismiss()
//                    }
//                }
//            } message: {
...
//                AddIngredientUsageView(ingredients: viewModel.ingredients)
//            }
//        }
//    }
//}
